...
<body>
    ...
    <h1>Produkty:</h1>
    <?php
    $command = "SELECT produkty.id, produkty.nazwa, produkty.opis, produkty.cena, produkty.stan, produkty.id FROM produkty";
    ...
    if(mysqli_num_rows($execute) == 0){
        ...
        while($product = mysqli_fetch_assoc($execute)){
            ...
            echo "<input type='hidden' name='produkt_id' value='{$product['id']}'>";
            echo "<input type='hidden' name='produkt_nazwa' value='{$product['nazwa']}'>";
